...
SPC_COLS = [  # "time", set as index when open spectrogram
    "LL_0.59",
    "LL_0.78",
    "LL_0.98",
    "LL_1.17",
...
SPC_COL_IDX = dict(zip(SPC_COLS, range(len(SPC_COLS))))
...
def spc_name_to_idx(names):
    return [SPC_COL_IDX[name] for name in names]
